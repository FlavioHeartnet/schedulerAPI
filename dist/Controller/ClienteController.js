...
var ReponseClass_1 = __importDefault(require("../Model/ReponseClass"));
...
var ClienteController = /** @class */ (function (_super) {
    ...
    ClienteController.prototype.insert = function (nome, cpf, DataNascimento) {
        ...
        var cpfVerify = firebase_1.db.collection(ClienteController.Collection).where('cpf', '==', cpf).get()
            ...
            return new ReponseClass_1.default("", "Erro ao buscar documentos");
        });
        return cpfVerify;
    };
    ...
    ClienteController.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        resp = this.getAllbyCollection(ClienteController.Collection);
                        return [4 /*yield*/, resp];
                    case 1:
                        data = _a.sent();
                        result = [];
    ...
    ClienteController.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getDocbyId(ClienteController.Collection, id)];
